...
class TablePeringkatRisiko extends React.PureComponent{
    constructor(props) {
        super(props);
        this.state = {
            sortedInfo: null,
    ...
    render() {
        ...
        return (
            <Card title={addbutton ? "Add New Data" : editbutton ? "Edit Data : "+eid : "Read Table Jenis Peringkat Risiko"}>
                {
                    addbutton ?
                        <SavePeringkatRisiko clickCancelAddButton={this.clickCancelAddButton}/> :
                    editbutton ?
...
export default TablePeringkatRisiko;