...
class SaveKpmrRatioIndikator extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
...
const WrapperSaveKpmrRatioIndikator = Form.create()(SaveKpmrRatioIndikator);
...
export default connect(mapStateToProps, {getAllPeringkatRisiko,postPeringkatRisiko,resetPostPeringkatRisiko,jenisNilaiParam})(WrapperSaveKpmrRatioIndikator);
