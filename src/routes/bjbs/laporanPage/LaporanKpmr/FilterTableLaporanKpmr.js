...
class FilterTableLaporanKpmr extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            dataoptions : [],
                    ...
                    !isInput ?
                        (<Card title={<div style={{textAlign: "center"}}>
                            <img src={require("assets/images/logobjbs-old.png")} className="gx-logo-size" alt="bjbs"
                                 title="bjbs"/><br/>
                            <label>Filter Laporan KPMR</label>
                        </div>}>
...
const WrappedFilterTableLaporanKpmr = Form.create()(FilterTableLaporanKpmr);
