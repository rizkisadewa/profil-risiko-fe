...
import {Divider, Button, Card, Table, Spin, Form} from "antd";
...
import {fetchAllParameterKuantitatif} from "../../../../appRedux/actions/Parameterkuantitatif";
...
const mapStateToProps = state => {
  return {
    authData: state.auth,
    parameterkuantitatif: state.parameterkuantitatif
  }
}

const mapDispatchToProps = dispatch => {
  return {
    fetchAllParameterKuantitatif: () => dispatch(fetchAllParameterKuantitatif())
  }
}

export default connect(mapStateToProps, mapDispatchToProps)(TableParameterKuantitatif);
